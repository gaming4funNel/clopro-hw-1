resource "yandex_compute_instance" "vm-public" {
  ...
  metadata = {
    ssh-keys = "ubuntu:${file("/home/ivanov/.ssh/id_ed25519.pub")}"
  }

  connection {
    type = "ssh"
    user = "ubuntu"
    private_key = file("/home/ivanov/.ssh/id_ed25519")
    host = "${yandex_compute_instance.vm-public.network_interface.0.nat_ip_address}"
  }

  provisioner "file" {
    source = "/home/ivanov/.ssh/id_ed25519"
    destination = "/home/ubuntu/.ssh/id_ed25519"
  }

  provisioner "file" {
    source = "/home/ivanov/.ssh/id_ed25519.pub"
